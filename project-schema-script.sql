...
CREATE TABLE IF NOT EXISTS `projschema`.`customers` (
  ...
  INDEX `fk_Customers_Membership1_idx` (`Membership_MembershipType` ASC),
...
CREATE TABLE IF NOT EXISTS `projschema`.`librarycollection` (
  ...
  INDEX `fk_LibraryCollection_Publisher1_idx` (`Publisher_PublisherName` ASC),
  INDEX `fk_LibraryCollection_ProductType1_idx` (`ProductType_ProductType` ASC),
...
CREATE TABLE IF NOT EXISTS `projschema`.`individual_items_in_collection` (
  ...
  PRIMARY KEY (`Barcode`),
  INDEX `fk_LoanableItems_IndividualItems_idx` (`LibraryCollection_Index_Number` ASC),
...
CREATE TABLE IF NOT EXISTS `projschema`.`librarycollection_has_creator` (
  ...
  INDEX `fk_LibraryCollection_has_Author_Author1_idx` (`Creator_CreatorID` ASC),
  INDEX `fk_LibraryCollection_has_Author_LibraryCollection1_idx` (`LibraryCollection_IndexNumber` ASC),
...
CREATE TABLE IF NOT EXISTS `projschema`.`librarycollection_has_subject` (
  ...
  INDEX `fk_LibraryCollection_has_Subject_Subject1_idx` (`Subject_SubjectName` ASC),
  INDEX `fk_LibraryCollection_has_Subject_LibraryCollection1_idx` (`LibraryCollection_IndexNumber` ASC),
...
CREATE TABLE IF NOT EXISTS `projschema`.`orders` (
  ...
  INDEX `fk_Orders_Employees1_idx` (`Employees_EmployeeID` ASC),
  INDEX `fk_Orders_Items1_idx` (`Individual_Items_In_Collection_Barcode` ASC),
